...
class MockData {
  ...
  static const posts = <Post>[
    Post(
      ...
      avatarEmoji: '🌿',
      time: '2小时前',
      text: '皮卡丘同款龟背竹开背啦！养了半年第一次看到完整裂叶，成就感满满 ✨',
      image: 'assets/images/monstera.png',
      likes: 328,
      comments: 46,
    ),
    Post(
      ...
      avatarEmoji: '🌵',
      time: '5小时前',
      text: '新手一定要试试月影系多肉，出状态之后粉粉的完全不用滤镜～',
      image: 'assets/images/succulent.png',
      likes: 156,
      comments: 22,
    ),
    Post(
      ...
      avatarEmoji: '🍃',
      time: '昨天 20:36',
      text: '琴叶榕长到 1 米 2 了！分享我的控水心得：宁干勿湿，盆插竹签判断干湿最靠谱。',
      image: 'assets/images/ficus.png',
      likes: 89,
      comments: 15,
    ),
  ...
  static const shareChannels = <String, String>{
    '微信好友': '💬',
    '朋友圈': '🌈',
    '微博': '🔥',
    'QQ': '🐧',
